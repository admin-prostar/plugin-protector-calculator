            ...
            <div class="container" id="calculator">
                ...
                <div id="calculator-graphics" class="calculator__graphics calculator-content">
                    ...
                    <div class="calculator__graphics__sides">
                        <img width="100%" src="/wp-content/plugins/protector-calculator/static/img/calculator/calculator-fencing-large.jpg" alt="" />
                    </div>
        ...
        <div class="calculator__summary__sides">
            <% if(A.len != ""){ %>
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr class="screen"><td colspan="2" class="calculator__email__cell border_img"><img src="/wp-content/plugins/protector-calculator/static/img/calculator/table-border.gif" alt="" style="display: block;" width="100%" height="1"></td></tr>
                    <tr class="screen"><td colspan="2" class="calculator__email__cell"><img src="/wp-content/plugins/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="5" style="display: block;"></td></tr>
                    <tr>
...
<script type="text/application" id="calculator-plan-template">
        <div class="calculator__plan">
            <div class="calculator__plan__header">
                <img width="100%" src="/wp-content/plugins/protector-calculator/static/img/calculator/plan-<%=systemId%>.jpg">
            </div>
...
<!-- a href="#" class="pill js-type <% if(type == 'pool-fencing'){%>pill--selected<%} %>" data-type="pool-fencing" data-type-name="Pool Fencing System">
...
<a href="#" class="pill pill--borderless-l js-type <% if(type == 'balustrading'){%>pill--selected<%} %>" data-type="balustrading" data-type-name="Balustrading System">
...
<div class="accordion calculator__summary__form">
    ...
    <div class="accordion__content accordion-is-expanded">
        ...
        <form action="/nz/wp-json/calculator/v1/send/" accept-charset="utf-8" id="calculator__components-summary" class="calculator__components-summary" method="post"><div style="display:none">
