...
<table class="table--responsive" cellspacing="0" cellpadding="0">
                ...
                if ($components) :
                    ...
                    <tr>
                        ...
                        <td class="calculator__email__cell">
                            <img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="25" style="display: block;"></td>
    ...
    <tr class="screen">
        <td colspan="11" class="calculator__email__cell" style="line-height: 1px; font-size: 1px;"><img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/table-border-dark.gif" alt="" style="display: block;" width="100%" height="1"></td>
    </tr>

    <tr class="calculator__email__hidden screen">
        <td class="calculator__email__cell">&nbsp;</td>
        <td colspan="5" class="calculator__email__cell" bgcolor="#2AB0E4" style="line-height: 10px; font-size: 1px;"><img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="10" style="display: block;"></td>
        <td class="calculator__email__cell" width="1"><img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/table-border-dark.gif" alt="" width="1" height="100%" style="display: block;"></td>
        <td colspan="4" class="calculator__email__cell" bgcolor="#2AB0E4" style="line-height: 10px; font-size: 1px;"><img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="10" style="display: block;"></td>
    </tr>
    ...
    <tr class="screen">
        <td colspan="11" class="calculator__email__cell" style="line-height: 10px; font-size: 1px;"><img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="10" style="display: block;"></td>
    </tr>
...
<div class="calculator__additional">
    ...
    <img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="30" style="display: block;" class="screen">
    ...
    <img src="<?php echo plugins_url(); ?>/protector-calculator/static/img/calculator/email/spacer.gif" alt="" width="100%" height="10" style="display: block;">
