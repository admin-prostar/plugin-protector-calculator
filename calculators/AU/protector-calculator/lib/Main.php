...
//        add_action('wp_mail_failed', [$this, 'onMailError'], 10, 1 );
    ...
    public function send_components(\WP_REST_Request $request)
    {
        ...
        $header = '<table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
            <td colspan="2"><img src="' . plugins_url() . '/protector-calculator/static/img/calculator/email/spacer.gif" style="display:block; width: 100%;" height="15" alt=""></td>
            </tr>
            <tr>
            ...
            <tr>
            <td><img src="' . plugins_url() . '/protector-calculator/static/img/calculator/email/spacer.gif" style="display:block; width: 100%;" height="12" alt=""></td>
            </tr>
            <tr>
            ...
            <tr>
            <td colspan="2"><img src="' . plugins_url() . '/protector-calculator/static/img/calculator/email/spacer.gif" style="display:block; width: 100%;" height="25" alt=""></td>
            </tr>
            </table>
            </td>
            </tr>
            ...
            <table width="590" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
            <td><img src="' . plugins_url() . '/protector-calculator/static/img/calculator/email/spacer.gif" style="display:block; width: 100%;" height="25" alt=""></td>
            </tr>
            <tr>
            <td align="left">
        ...
        $footer = '</td>
            ...
            <table width="590" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
            <td colspan="2"><img src="' . plugins_url() . '/protector-calculator/static/img/calculator/email/spacer.gif" style="display:block; width: 100%;" height="40" alt=""></td>
            </tr>
            <tr>
