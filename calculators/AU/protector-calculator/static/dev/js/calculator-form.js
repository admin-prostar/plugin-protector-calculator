...
var CalculatorFormView = Backbone.Marionette.ItemView.extend({
        ...
        $('form.calculator__components-summary').ajaxForm({
            ...
            success: function() {
                ...
                if (typeof gtag !== 'undefined') {
                    gtag('event', 'Click', {
                        'event_category' : 'Fence Calculator - Form Complete',
                        'event_label' : t.model.get('typeName') + ' ' + t.model.get('systemIconCode'),
    ...
    trackBunnings: function() {
        ...
        if (typeof gtag !== 'undefined') {
            gtag('event', 'Click', {
                'event_category' : 'Fence Calculator - Bunnings Button',
